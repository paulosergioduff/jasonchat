...
abstract Class WhiteList 
{
				...
				private $page;
				private $list;
				public abstract function add_contact($protocol, $serverOrigin, $serverDestiny, $target, $type, $nat, $autor, $menssage);
				...
				public abstract function remove_contact($serverOrigin, $serverDestiny, $contact);
}
...
abstract Class BlackList 
{
				...
				public abstract function unBlock_target($serverOrigin, $serverDestiny, $contact);
}
